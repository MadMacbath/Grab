...
public class Constants {
    // 抓取根目录
    public static String URL_PATH = "https://www.csdn.net";//"https://www.jd.com";//"http://www.atguigu.com/";//"https://www.csdn.net";
    // 图片路径规则
    ...
    // 文件存储位置，二级目录
    public static String SAVE_FILE_SECOND_PATH = "CSDN";
    // 图片格式
